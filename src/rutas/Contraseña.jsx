...
const handleSubmit = async (event) => {
  if (formData.dni == "" || formData.contraseña == ""){
    ...
    try {
      const response2 = await fetch('http://localhost:8080/api/usuario/login', {
            ...
            body: JSON.stringify({dni:formData.dni, password:formData.contraseña})
        });
    ...
    <View style={styles.container}>
      ...
      >
        ...
        />
          ...
          <Link to={`/generarContraseña/${formData.dni}`} component={Pressable} style={[styles.buttonaceptar, styles.acceptButton]}>
